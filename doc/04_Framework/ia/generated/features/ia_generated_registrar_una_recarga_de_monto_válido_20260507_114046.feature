@ia-generated
Feature: Registrar una recarga de monto válido - Generado por IA
  # Historia: Como agente de Telco Operator quiero registrar una recarga de monto válido para un cliente activo para generar un comprobante de pago
  # Generado: 2026-05-07T11:40:46.111243 | Modo: template
